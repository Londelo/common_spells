...
const NormalizeBranchNames = ( defaultBranch: string, currentBranch: string ) => ( collection: string[], {
  name, isStale, lastCommitDate
}: BranchDetails ) => {
...
( async() => errorHandlerWrapper( checkOut, errorMessage ) )();
